...
%size of Theta1 25x401
Theta2 = reshape(nn_params((1 + (hidden_layer_size * (input_layer_size + 1))):end), ...
                 num_labels, (hidden_layer_size + 1));
%size of Theta2 10x26
% Setup some useful variables
m = size(X, 1);  % m = 5000 examples
...
% PART 1: FEED-FORWARD 
Y = zeros(m,num_labels); % Y 5000 x 10
for i=1:m
 Y(i,y(i)) = 1;
end

a1 = [ones(m,1), X]; % X 5000x400 X1 5000x401 
z2 = a1 * Theta1';   % z1 5000x401 * 401x25 = 5000x25
a2 = [ones(m,1), sigmoid(z2)]; %a1 5000x26
z3 = a2 * Theta2'; % a1 5000x26 26x10 = 5000x10
a3 = sigmoid(z3);  % a2 5000 x 10
h_theta = a3;

J = sum(sum( -Y.*log(a3) - (1-Y).*log(1-a3) ))/m; %sum(sum(5000x10))
